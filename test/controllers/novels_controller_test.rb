...
class NovelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create novel" do
    assert_difference('Novel.count') do
      post novels_url, params: { novel: { author: @novel.author, ccontent: @novel.ccontent, title: @novel.title } }
    end
  ...
  test "should update novel" do
    patch novel_url(@novel), params: { novel: { author: @novel.author, ccontent: @novel.ccontent, title: @novel.title } }
